...
import { useMemo, Suspense, memo, type ReactNode } from "react";

// ─── Loading Component ───────────────────────────────────────────────────────
const SectionLoader = () => (
  <div className="h-96 animate-pulse bg-[#0a0a0b] flex items-center justify-center">
...
const projects = [
  {
    ...
    description: "A restrained identity and website architecture for a capital advisory firm that needed trust before flair.",
    result: "38% lift in qualified enquiries",
    tags: ["Identity", "UX", "Copy"],
    className: "md:col-span-4 lg:col-span-3 md:row-span-2",
    gradient: "from-[#C5A059]/45 via-[#141416] to-[#050505]",
  },
  {
    title: "Maison Interface",
    eyebrow: "Luxury product experience",
    description: "A commerce interface built around editorial pacing, high-contrast imagery, and conversion without visual noise.",
    result: "2.4x product-page engagement",
    tags: ["Product", "Commerce"],
    className: "md:col-span-2 lg:col-span-3",
    gradient: "from-[#E8D8B0]/35 via-[#141416] to-[#050505]",
  },
  {
    title: "Northline Studio",
    eyebrow: "Agency positioning",
    description: "Strategy, messaging, and a sharper portfolio system for an agency moving into higher-value retainers.",
    result: "Retainer value increased",
    tags: ["Strategy", "Web"],
    className: "md:col-span-2 lg:col-span-3",
    gradient: "from-[#8C6D31]/45 via-[#141416] to-[#050505]",
  },
  {
    title: "Archive OS",
    eyebrow: "Editorial knowledge hub",
    description: "A long-form publishing system optimized for readability, depth, and compounding search visibility.",
    result: "65ch reading system",
    tags: ["MDX", "SEO"],
    className: "md:col-span-3 lg:col-span-2",
    gradient: "from-[#C5A059]/30 via-[#141416] to-[#050505]",
  },
  {
    title: "Venture Room",
    eyebrow: "Founder narrative",
    description: "A premium landing page and investor narrative system for an early-stage technical founder.",
    result: "Narrative clarified pre-raise",
    tags: ["Pitch", "Narrative"],
    className: "md:col-span-3 lg:col-span-2",
    gradient: "from-[#E8D8B0]/25 via-[#141416] to-[#050505]",
  },
  {
    title: "Obsidian Index",
    eyebrow: "Visual research system",
    description: "A visual language and design direction engine for teams that need taste made operational.",
    result: "Reusable aesthetic framework",
    tags: ["Research", "Systems"],
    className: "md:col-span-6 lg:col-span-2",
    gradient: "from-[#C5A059]/35 via-[#141416] to-[#050505]",
  },
];
...
const MiniMark = memo(function MiniMark() {
  return (
    ...
    >
      ...
      `}</style>
      <span className="absolute size-5 rounded-full border border-[rgba(197,160,89,0.4)] animate-spin-slow" />
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[20rem] sm:max-w-[24rem] lg:max-w-[28rem]">
      ...
      >
        ...
        <div
          className="absolute inset-9 rounded-full opacity-80 animate-spin-reverse sm:inset-12"
          style={{
            ...
            maskImage: "radial-gradient(circle, transparent 0 45%, black 46% 61%, transparent 62%)",
          }}
        />
        <div className="relative grid h-full place-items-center rounded-full">
          <div className="text-center">
            ...
            <p className="mt-2 font-serif text-6xl leading-none text-[#e8d8b0] sm:mt-3 sm:text-8xl">SS</p>
    ...
    <section className="relative min-h-screen px-4 pb-16 pt-28 sm:px-6 lg:px-8 lg:pb-20 lg:pt-36">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to right, rgba(197,160,89,0.08) 1px, transparent 1px), linear-gradient(to bottom, rgba(197,160,89,0.05) 1px, transparent 1px)",
      ...
      <div className="mx-auto grid max-w-[1280px] items-center gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:gap-14">
        <div className="max-w-4xl">
          <Reveal>
            ...
            >
              <span className="size-1.5 rounded-full bg-[#c5a059]" style={{ boxShadow: "0 0 8px rgba(197,160,89,0.6)" }} />
          ...
          <Reveal delay={0.4}>
            <dl className="mt-10 grid max-w-2xl grid-cols-3 border-y sm:mt-14" style={{ borderColor: "rgba(197,160,89,0.2)" }}>
              {stats.map((stat, index) => (
                <div
                  ...
                  style={{ borderColor: "rgba(197,160,89,0.2)" }}
                >
                  <dt className="font-serif text-2xl text-[#e8d8b0] sm:text-3xl">{stat.value}</dt>
        ...
        {capabilities.map((capability, index) => (
          <Reveal key={capability.title} delay={index * 0.08}>
            <div className="bg-[#0a0a0b] p-5 transition-colors hover:bg-[#141416] sm:p-7">
              <p className="font-serif text-2xl font-semibold text-[#f4f4f5] sm:text-3xl">{capability.title}</p>
              <p className="mt-3 text-sm leading-relaxed text-[#8a8a93] sm:mt-4 sm:text-base">{capability.body}</p>
            </div>
          </Reveal>
        ))}
      </div>
...
function AboutSection() {
  return (
    <section id="about" className="mx-auto max-w-[1280px] px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
      <div className="grid gap-12 sm:gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-24">
        <div className="flex flex-col justify-between gap-8 sm:gap-10">
          <div>
            ...
            <div className="ruled-line mt-4 mb-6 h-px w-12 bg-gradient-to-r from-[rgba(197,160,89,0.9)] to-transparent sm:mt-5 sm:mb-8" />
            ...
            <div className="ruled-line mt-6 h-px w-12 bg-gradient-to-r from-[rgba(197,160,89,0.9)] to-transparent sm:mt-8" />
          </div>

          <div className="flex flex-wrap gap-2 sm:gap-3">
            {["Brand Systems", "UX Strategy", "Editorial Design", "Visual Research", "Founder Positioning"].map((tag) => (
              <span
                key={tag}
        ...
        <div className="space-y-8 sm:space-y-10">
          ...
          <p className="text-sm leading-relaxed text-[#8a8a93] sm:text-base sm:leading-8">
            ...
            the highest-value businesses don&apos;t shout — they signal. Premium is
            not a budget. It is a vocabulary.
          </p>
          ...
          <div className="space-y-4 border-t pt-6 sm:space-y-5 sm:pt-8" style={{ borderColor: "rgba(197,160,89,0.2)" }}>
            <p className="text-[0.6rem] font-medium tracking-[0.3em] text-[#c5a059] uppercase">
              Operating principles
            </p>
            {[
              ["Restraint first", "The instinct to add is almost always wrong. Remove until only the essential remains."],
              ["Taste is operational", "Visual rules, pattern libraries, and editorial systems make good taste repeatable at scale."],
              ["Precision over speed", "One considered decision is worth a hundred fast ones. Clients don't pay for effort — they pay for outcomes."],
            ].map(([title, body]) => (
              <div key={title as string} className="flex gap-3 sm:gap-5">
                <div className="mt-1.5 shrink-0 sm:mt-2">
                  <div className="size-1.5 rounded-full bg-[#c5a059]" style={{ boxShadow: "0 0 6px rgba(197,160,89,0.6)" }} />
                </div>
                <div>
                  <p className="text-xs font-semibold text-[#f4f4f5] sm:text-sm">{title}</p>
                  <p className="mt-0.5 text-xs leading-relaxed text-[#8a8a93] sm:mt-1 sm:text-sm">{body}</p>
                </div>
              </div>
            ))}
          </div>
...
function PortfolioBento() {
  ...
  const containerVariants = useMemo(() => 
    reduceMotion ? {} : { hidden: {}, show: { transition: { staggerChildren: 0.08 } } }
  , [reduceMotion]);
  ...
  return (
    <section id="work" className="relative mx-auto max-w-[1280px] px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
      <motion.div
      ...
      >
        {projects.map((project, index) => (
          <motion.article
            ...
            style={{
              background: "linear-gradient(145deg, rgba(20,20,22,0.72) 0%, rgba(5,5,5,0.82) 100%)",
              backdropFilter: "blur(18px) saturate(160%)",
            }}
          >
            {/* Gradient border */}
            <div
              className="absolute inset-0 pointer-events-none transition-all duration-600 group-hover:bg-gradient-145"
              style={{
                padding: "1px",
                background: "linear-gradient(145deg, rgba(197,160,89,0.38) 0%, rgba(197,160,89,0.06) 40%, rgba(197,160,89,0.18) 100%)",
            ...
            {/* Color gradient bg */}
            <div
              className={`absolute inset-0 bg-gradient-to-br from-[${project.gradient.split(" ")[0]}] via-[${project.gradient.split(" ")[1]}] to-[${project.gradient.split(" ")[2]}] opacity-90 saturate-0 transition duration-700 ease-out group-hover:scale-105 group-hover:saturate-100`}
            />
            ...
            <div
              ...
              style={{
                backgroundImage: "linear-gradient(to right, rgba(244,244,245,0.05) 1px, transparent 1px), linear-gradient(to bottom, rgba(244,244,245,0.05) 1px, transparent 1px)",
            ...
            <div
              ...
              style={{
                background: "linear-gradient(105deg, transparent 30%, rgba(197,160,89,0.09) 50%, transparent 70%)",
            ...
            <div className="relative z-20 flex h-full flex-col justify-between p-6 sm:p-8">
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-right font-serif text-xl text-[#e8d8b0] sm:text-2xl">{project.result}</p>
                </div>
              </div>
            </div>
...
function LessonsSection() {
  return (
    <section id="lessons" className="mx-auto max-w-[1280px] px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
